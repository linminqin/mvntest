...
class PacketReader {
    ...
    private XMPPTCPKeepAliveConnection connection;
    ...
    protected PacketReader(final XMPPTCPKeepAliveConnection connection) throws SmackException {
