		...
		<div class="container_content">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<form id="mainForm" action="<c:url value="/basedata/game/list.shtml"/>" method="post" class="form-vertical">
					...
					<div class="row-fluid">
						<jsp:include page="/jdp/include/addMenu.jsp">
							<jsp:param value="basedata_game_add" name="authorityCode"/>
							<jsp:param value="/basedata/game/load.shtml?${httpParamOpenMode }=${createOpenMode }&modulePath=${modulePath }&menuFrom=${param.menuFrom }&subMenuId=${param.subMenuId }" name="addUrl"/>
						</jsp:include>
						<jsp:include page="/jdp/include/batchDeleteMenu.jsp">
							<jsp:param value="basedata_game_delete" name="authorityCode"/>
							<jsp:param value="basedata/game/batchDelete.shtml" name="deleteUrl"/>
						</jsp:include>
						<jsp:include page="/jdp/include/favoriteMenu.jsp">
							<jsp:param value="basedata_game_load" name="menuId"/>
						</jsp:include>
					</div>
					<div class="row-fluid">
					<table class="listContent table table-bordered table-striped with-check table-hover">
						<thead>
							<tr>
								...
								<th style="width: 110px;" class="sortable sorted_name"><a href="javascript:pageSort('name')">游戏名称</a></th>
								...
								<lauthority:checkAuthority authorityCode="basedata_game_delete">
						...
						<tbody>
							<c:forEach var="item" items="${page.items}" varStatus="status">
									<tr>
										...
										<td>
											<lauthority:checkAuthority authorityCode="basedata_game_load">
												<a href="javascript:void(0)" class="td_2" onclick="redirectPage('<c:url value="/basedata/game/load.shtml?id=${item.id}&${httpParamOpenMode }=${readOpenMode }"/>&modulePath=${modulePath }&menuFrom=${param.menuFrom }&subMenuId=${param.subMenuId }', 800, 600)">
													<i class="icon icon-circle-arrow-up"></i> 查看
												</a>
											</lauthority:checkAuthority>
											<lauthority:checkAuthority authorityCode="basedata_game_modify">
												&nbsp;
												<a href="javascript:void(0)" class="td_2" onclick="redirectPage('<c:url value="/basedata/game/load.shtml?id=${item.id}&${httpParamOpenMode }=${editOpenMode }"/>&modulePath=${modulePath }&menuFrom=${param.menuFrom }&subMenuId=${param.subMenuId }', 800, 600)">
													<i class="icon icon-edit"></i> 修改
												</a>
											</lauthority:checkAuthority>
											<lauthority:checkAuthority authorityCode="basedata_game_delete">
												&nbsp;
												<a href="javascript:void(0)" onclick="deletePojo('<c:url value="/basedata/game/delete.shtml?id=${item.id}"/>')" class="td_2">
