		...
		<div class="container_content">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<div class="row-fluid">
					<form:form id="mainForm" action="${ctx}/basedata/channel/save.shtml" method="post" commandName="pojo" class="form-horizontal">
					...
					<div class="span12 nomargin">
						<div class="widget-box form-table">
							<div class="widget-title">
								...
								<h5>
									<c:choose>
					       				<c:when test="${param[httpParamOpenMode] == createOpenMode }">添加渠道</c:when>
					       				<c:when test="${param[httpParamOpenMode] == editOpenMode }">修改渠道</c:when>
					       				<c:otherwise>渠道信息</c:otherwise>
					       			</c:choose>
								</h5>
							</div>
							<div class="nopadding">
