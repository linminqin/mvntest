		...
		<div class="container_content">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<div class="row-fluid">
					<form:form id="mainForm" action="${ctx}/query/game/consumeimport.shtml" method="post" 
							...
							<div class="nopadding">
									...
									<div class="control-group">
										...
										<div class="controls" style="  padding-top: 15px;">
											Excel文件，每行的字段顺序如下：渠道编号，游戏编号，金额（分）；从第一行开始（无需标题行）。
										</div>
									</div>
									<div class="form-actions">
										...
										<button type="button" class="btn btn-primary"
											onclick="back('/query/game/queryimportconsume.shtml')">返回</button>
									</div>
							</div>
						</div>						
					</div>
