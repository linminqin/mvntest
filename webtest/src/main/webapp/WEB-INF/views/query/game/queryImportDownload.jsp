		...
		<div class="container_content">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<form id="mainForm" action="<c:url value="/query/game/queryimportdownload.shtml"/>" method="get" class="form-vertical">
					...
					<div class="row-fluid">
						<lauthority:checkAuthority authorityCode="query_game_importdownload_import">
								<button type="button" class="btn" onClick="redirectPage('<c:url value="/" />query/game/toactivateimport.shtml?modulePath=${modulePath }&menuFrom=${param.menuFrom }&subMenuId=${param.subMenuId }')"><i class="icon-plus"></i> 导入</button>
						</lauthority:checkAuthority>
						<jsp:include page="/jdp/include/favoriteMenu.jsp">
							<jsp:param value="query_game_importdownload_load" name="menuId"/>
						</jsp:include>
					</div>
					<div class="row-fluid">
						...
						<tbody>
							<c:forEach var="item" items="${page.items}" varStatus="status">
									<tr>
										...
										<td><fmt:formatNumber value="${item.download}" pattern="###,###,###,###,##0"/></td>
									...
									<tr>
										...
										<th>&nbsp;</th>
										<th><fmt:formatNumber value="${countData.downloadCount }" pattern="###,###,###,###,##0"/></th>
										<th>&nbsp;</th>
									</tr>
									<tr>
										<td colspan="
