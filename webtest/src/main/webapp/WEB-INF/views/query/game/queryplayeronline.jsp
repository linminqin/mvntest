		...
		<div class="container_content">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<form id="mainForm" action="<c:url value="/query/game/queryplayeronline.shtml"/>" class="form-vertical">
					...
					<div class="row-fluid">
						<div class="span12">
							<div class="widget-box border-radius">
								...
								<div class="nopadding control-group">
										<label class="control-label"  style="width: 70px;">登陆时间：</label>
					...
					<div class="row-fluid">
						<jsp:include page="/jdp/include/favoriteMenu.jsp">
							<jsp:param value="query_game_playeronline_load" name="menuId"/>
						</jsp:include>
					</div>
					<div class="row-fluid">
