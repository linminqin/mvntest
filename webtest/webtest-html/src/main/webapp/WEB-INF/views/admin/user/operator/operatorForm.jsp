...
<%@ page import="com.lmiky.admin.user.pojo.User,com.lmiky.admin.form.controller.FormController"%>
					...
					<div class="span12 nomargin">
						<div class="widget-box form-table">
							...
							<div class="nopadding">
									...
									<jsp:include page="<%=(String)request.getAttribute(FormController.HTTP_PARAM_FORM_SUBFORM)%>" />
							</div>
						</div>						
					</div>
					</form:form>
