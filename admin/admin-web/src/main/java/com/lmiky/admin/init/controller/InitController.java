package com.lmiky.admin.init.controller;
...
public class InitController extends BaseWebController {
	...
	private Boolean allowInit = BundleUtils.getBooleanValue(Constants.PROPERTIES_KEY_ADMIN_FILE, "system.allowInit");
