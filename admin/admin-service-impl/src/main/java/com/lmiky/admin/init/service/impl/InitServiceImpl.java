package com.lmiky.admin.init.service.impl;
...
public class InitServiceImpl extends BaseServiceImpl implements InitService {
	...
	/*
	 * (non-Javadoc)
	 * @see com.lmiky.admin.init.service.InitService#init(java.lang.String, java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.lmiky.admin.init.service.InitService#updateModule()
	 */
	@Transactional(rollbackFor = { Exception.class })
	...
	/* (non-Javadoc)
	 * @see com.lmiky.admin.init.service.InitService#updateMenu()
	 */
